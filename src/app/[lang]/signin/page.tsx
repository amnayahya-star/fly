      ...
      >
        <div className="relative w-full rounded-[2rem] p-8 sm:p-10 bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_0_40px_rgba(3,42,112,0.5)]">
          <div className="mb-8 text-center">
            ...
            >
              <Plane className="w-8 h-8 text-[#4CA1FF] -rotate-45" />
            </motion.div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button 
              type="submit"
              className="mt-2 w-full bg-white/10 hover:bg-[#0066FF] text-white border border-white/20 hover:border-[#0066FF] py-3.5 rounded-xl font-semibold flex items-center justify-center gap-2 transition-all shadow-lg group overflow-hidden relative"
            >
              ...
              <span className="relative z-10 text-[15px]">Sign In</span>
